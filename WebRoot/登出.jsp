...
<div class="wrapper">
    <div class="sidebar" data-color="DarkKhaki" data-image="assets/img/sidebar-5.jpg">
                        ...
                        <div class="col-2-3">
                            <div class="wrap-col">
                                <div class="item-container">
                                    ...
                                    <div class="item-caption green">
                                        <a href=" <a href="${ pageContext.request.contextPath }/index.action">">
                                            <div class="item-caption-inner">
                                                <div class="item-caption-inner1">
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'pe-7s-gift',
            	message: "欢迎来到<b>我的个人小站</b> - 与你们分享我的生活"
