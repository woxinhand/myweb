...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/reset2.css"> <!-- CSS reset -->
	...
	c92.133,0,184.265-35.148,254.559-105.441C724.852,584.264,760,492.133,760,400.001C760,307.869,724.852,215.736,654.559,145.441z">
				...
				<li class="left">
					<div class="svg-wrapper">
						<svg viewBox="0 0 800 800">
							...
							<image href= "${pageContext.request.contextPath}/tupian.action" height='800px' width="800px" clip-path="url(#cd-image-1)" xlink:href="assets/img/img-01.jpg"></image>
				...
				<li class="selected">
					<div class="svg-wrapper">
						<svg viewBox="0 0 800 800">
							...
							<image height='800px' width="800px" clip-path="url(#cd-image-2)" xlink:href="assets/img/img-02.jpg"></image>
				...
				<li class="right">
					<div class="svg-wrapper">
						<svg viewBox="0 0 800 800">
							...
							<image height='800px' width="800px" clip-path="url(#cd-image-3)" xlink:href="assets/img/img-03.jpg"></image>
				...
				<li>
					<div class="svg-wrapper">
						<svg viewBox="0 0 800 800">
							...
							<image height='800px' width="800px" clip-path="url(#cd-image-4)" xlink:href="assets/img/img-04.jpg"></image>
				...
				<li>
					<div class="svg-wrapper">
						<svg viewBox="0 0 800 800">
							...
							<image height='800px' width="800px" clip-path="url(#cd-image-5)" xlink:href="assets/img/img-05.jpg"></image>
		...
		<ul class="caption">
			...
			<li class="right">Dolorem inventore voluptates tenetur</li>
			<li>Error officiis quae</li>
			<li>Provident repellendus eveniet</li>
		</ul>
